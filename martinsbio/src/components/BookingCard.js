...
export default function BookingCard({BookingObject, movies}) {
    ...
    function checkout() {
        ...
        alert("You made it, you booked Your tuckets.. Dunno how to add shit.. Dunno how to display what you just did.. Asshole! Guess... You take info from the array... and edit stuff.. And use index or file system,. Or something... A post fetch, who gives a shit..")
    }
